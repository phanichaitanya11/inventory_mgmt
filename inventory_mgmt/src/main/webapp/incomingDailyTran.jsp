...
<body>
	...
	<script src="assets/js/validators/incomingDailyTran-form-validator.js"></script>
	<div id="page-wrapper">
		<div id="page-inner">
			<div class="row">
				<div class="col-md-12">
									...
									<form:form method="POST" name="searchAgentForm" id="searchAgentForm" action="searchAgentForTran" modelAttribute="newTranForm">
										<div class="form-group">
	                                        <div class="input-group">
												...
												<form:hidden path="tranType" name="tranType" value="I"/>
											</div>
										</div>
					...
					<c:if test="${agentExist}">
									...
									<div class="col-md-10">
										<form:form class="form-horizontal" modelAttribute="agentInfo">
											...
											<div class="form-group">
		                                    	...
		                                    	<div class="col-sm-5">
													<button type="button" id="newTransactionBtn" name="newTransactionBtn" class="btn btn-default">New Incoming Transaction</button>
												</div>
											</div>
										</form:form>
									</div>
						...
						<div id="newTranDiv" class="panel panel-primary" style="display: none;">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-10">
										<form:form class="form-horizontal" name="newIncomingTranForm" id="newIncomingTranForm" method="POST" action="newIncomingTran" modelAttribute="newTranForm">
											<div class="form-group">
	                                            <label for="agentId" class="col-sm-3 control-label">Agent ID</label>
	                                            <div class="col-sm-5">
												  <form:input id="agentId" path="agentId" name="agentId" class="form-control" placeholder="Agent ID" disabled="true"/>
										    ...
										    <div class="form-group">
												<label for="totalProdVolume" class="col-sm-3 control-label">Total Products Volume</label>
		                                    	<div class="col-sm-5">
													<form:input path="totalProdVolume" name="totalProdVolume" id="totalProdVolume" class="form-control" placeholder="Total Product Volume"/>
												</div>
											</div>
										    <div class="form-group">
												<label for="approvedVol" class="col-sm-3 control-label">Approved Volume</label>
		                                    	<div class="col-sm-5">
													<form:input path="approvedVol" name="approvedVol" id="approvedVol" class="form-control" placeholder="Approved Product Volume"/>
												</div>
											</div>
											<div class="form-group">
												<label for="reject1Vol" class="col-sm-3 control-label">Reject 1 Volume</label>
		                                    	<div class="col-sm-5">
													<form:input path="reject1Vol" name="reject1Vol" id="reject1Vol" class="form-control" placeholder="Reject 1 Volume"/>
												</div>
											</div>
											<div class="form-group">
												<label for="reject2Vol" class="col-sm-3 control-label">Reject 2 Volume</label>
		                                    	<div class="col-sm-5">
													<form:input path="reject2Vol" name="reject2Vol" id="reject2Vol" class="form-control" placeholder="Reject 2 Volume"/>
												</div>
											</div>
											<div class="form-group">
												<div class="col-sm-3">&nbsp;</div>
