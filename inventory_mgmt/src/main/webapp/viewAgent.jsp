...
<body>
	...
	<script src="assets/js/validators/viewAgent-form-validator.js"></script>
	<div id="page-wrapper">
		<div id="page-inner">
			<div class="row">
				<div class="col-md-12">
					...
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-md-6">
									<form:form method="POST" name="searchAgentForm" id="searchAgentForm" action="viewAgent" modelAttribute="viewAgentForm">
					...
					<c:if test="${agentExist}">
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-10">
										<form:form class="form-horizontal" name="viewAgentForm" id="viewAgentForm" method="POST" action="updateAgent" modelAttribute="viewAgentForm">
